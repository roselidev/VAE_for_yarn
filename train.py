...
def train(configuration):
    ...
    concat_dataloader = dl.get_dataloader(configuration)
    ...
    # only optimize the decoder in the model (!) #TODO change
    try:
    ...
    while epoch < epochs:
        ...
        while True:
            ...
            if iteration % 100 == 0:
                print('data/training_loss_style', torch.sum(loss_s).item(), iteration)
                print('data/training_feature_loss_style', torch.sum(content_feature_loss).item(), iteration)
                print('data/training_per_pixel_loss_style', torch.sum(per_pixel_loss).item(), iteration)
            ...
            if iteration % 10 == 0:
                print('data/training_loss_content', torch.sum(loss_c).item(), iteration)
                print('data/training_feature_loss_content', torch.sum(content_feature_loss).item(), iteration)
                print('data/training_per_pixel_loss_content', torch.sum(per_pixel_loss).item(), iteration)
